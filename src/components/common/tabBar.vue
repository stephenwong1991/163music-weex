<!--
  This components copy in 'weex-ui', modify by wang-sai
  see: https://github.com/alibaba/weex-ui/blob/master/packages/wxc-tab-bar/index.vue
-->
  ...
  <div class="wxc-tab-page" :style="{backgroundColor:wrapBgColor }">
    ...
    <div class="tab-title-list"
      ...
      <div class="title-item"
        ...
        <v-image :src="currentPage == index ? v.activeIcon : v.icon"
                v-if="titleType === 'icon' && !titleUseSlot"
                :style="{ width: tabStyles.iconWidth + 'px', height:tabStyles.iconHeight+'px'}"></v-image>
